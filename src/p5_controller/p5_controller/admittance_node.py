...
class EEAdmittance(Node):
    def __init__(self):
        ...
        self.create_subscription(WrenchStamped, '/alice_force_torque_sensor_broadcaster/wrench',
                                 self.wrench_cb, 10)
    ...
    def get_current_ee_pose(self):
        # Placeholder function to get current end-effector pose.

        new_pose = self.x_ref + self.x_ee
